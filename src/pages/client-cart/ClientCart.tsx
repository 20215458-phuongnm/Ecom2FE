              ...
              <Table verticalSpacing="md" horizontalSpacing="lg">
                ...
                <tbody>
                  ...
                  {cart.cartItems.length === 0 && (
                    <tr>
                      <td colSpan={5}>
                        <Stack my={theme.spacing.xl} sx={{ alignItems: 'center', color: theme.colors.orange[5] }}>
              ...
              <Stack spacing="xs">
                <Stack spacing="sm">
                  ...
                  <Group position="apart">
                    ...
                    <Text size="lg" weight={700} color="orange" sx={{ textAlign: 'right' }}>
...
//Hiển thị một hàng trong bảng giỏ hàng
function CartItemTableRow({ cartItem }: { cartItem: ClientCartVariantResponse }) {
  ...
  return (
    <tr key={cartItem.cartItemVariant.variantId}>
      ...
      <td>
        <Text weight={500} size="sm" color="orange">
...
//Xử lý xác nhận đơn hàng sau khi đặt mua
function ConfirmedOrder() {
  ...
  useEffect(() => {
    if (checkoutPaypalStatus === 'none') {
      ...
      createClientOrder(request); //Gửi yêu cầu tạo đơn hàng
    }
  ...
  if (clientConfirmedOrderResponse && clientConfirmedOrderResponse.orderPaymentMethodType === PaymentMethodType.CASH) {
    contentFragment = (
      <Stack justify="space-between" sx={{ height: '100%' }}>
        <Stack align="center" sx={{ alignItems: 'center' }}>
          <Check size={100} strokeWidth={1} />
          <Text sx={{ fontSize: '1.25rem' }}>
            <span style={{ color: '#FFAA47' }}>Đơn hàng </span>
            <Anchor
              component={Link}
            ...
            <span style={{ color: '#FFAA47' }}> đã được tạo!</span>
          </Text>
        </Stack>
