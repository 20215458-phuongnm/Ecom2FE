...
function ClientCategory() {
  ...
  const handlePriceOptionChips = (priceOptions: string[]) => {
    ...
    for (const priceOption of priceOptions) {
      ...
      if (priceOptionArray[1] === 'max') {
        expressions.push(`variants.price=bt=(${priceOptionArray[0]},1000000000)`); //Chia khoảng
      } else {
  ...
  return (
    <main>
      {/* console.log('Tổng số thương hiệu:', filter.filterBrands.length); */}
