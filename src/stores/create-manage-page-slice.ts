...
// Tạo slice (1 phần state) cho ManagePage với các phương thức và trạng thái ban đầu
const createManagePageSlice: SliceCreator<ManagePageState> = (set, get) => ({
  ...
  getRequestParams: () => ({ //chuyển đổi các giá trị trong state thành RequestParams
    page: get().activePage,
